...
import HeadW from "../assets/images/ConstH.png";
  ...
  return (
    <header className="bg-black text-white h-[100vh] md:h-190 w-[100%] flex flex-col relative overflow-none ">
      ...
      >
        ...
        <div className="hidden lg:flex w-[45%] justify-between">
          <ul className="flex w-[62%] justify-evenly items-center font-semibold">
            <li>
          ...
          <button className="flex justify-center w-40 py-2 bg-white text-black font-semibold rounded cursor-pointer hover:bg-gray-100">
            Request a Quote
          </button>
        </div>
      ...
      <main className="sm:px-15 px-5 mt-12 w-[100%]">
        ...
        >
          <h1>Solidity</h1>
          <h1 className="ml-[-1vw]">Quality</h1>
          <h1 className="ml-[-1vw]">Precision</h1>
          <h1 className="ml-[-1vw]">Innovation</h1>
        </motion.div>
        ...
        >
          <h1 className=" text-5xl md:text-7xl font-semibold">
            Building a Foundation <br /> That Lasts.
          </h1>
          <p>
            A&M Construction Services is dedicated to delivering excellence with
            every project. We provide comprehensive construction solutions built
            on a commitment to quality, safety, and innovation.
          </p>
        ...
        <motion.img
          ...
          src={HeadW}
          alt=""
          className=" rounded-full absolute top-[15%] sm:top-[15%] right-[2%] sm:right-10 sm:h-160 h-90 lg:flex sm:hidden flex"
        />
      </main>
    </header>
  );
